...
const ENTITY_DEFINITIONS = {
  products: {
    ...
    fields: [
      ...
      { key: 'taxTypeCode', label: 'Tax Type Code', required: false, section: 'Tax and EBM', example: 'B', instructions: 'Optional. Defaults from the company tax setup or B (18% VAT).' },
      { key: 'itemClassCode', label: 'Item Classification Code', required: false, section: 'Tax and EBM', example: '50202306', instructions: 'Optional. Matched against synced RRA classes, then inferred from the product name.' },
      { key: 'packagingUnitCode', label: 'Packaging Unit Code', required: false, section: 'Tax and EBM', example: 'NT', instructions: 'Optional. Matched against synced RRA codes, then defaults from the product unit.' },
      { key: 'quantityUnitCode', label: 'Quantity Unit Code', required: false, section: 'Tax and EBM', example: 'L', instructions: 'Optional. Matched against synced RRA codes, then defaults from the product unit.' },
      { key: 'supplier', label: 'Supplier', required: false, section: 'Relationships', example: 'Kigali Fresh Foods Ltd', instructions: 'Optional. Matched to an existing supplier or created as a draft supplier.' },
      { key: 'brand', label: 'Brand', required: false, section: 'Basic information', example: 'Inyange', instructions: 'Optional. Matched against existing values when available.' },
